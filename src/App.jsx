        ...
        <div style={{flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minHeight:0}}>
          ...
          {readSearchRes&&tab==='read'&&!readMobileSheet&&(
            <div className="srch-bar-fixed" style={{position:'fixed',top:navH,left:0,right:0,zIndex:210,
              ...
              <div style={{height:1,background:T.accentLine,position:'absolute',bottom:0,left:0,right:0,transform:'translateY(100%)'}}/>
              <button type="button" onClick={()=>{setReadSearchRes(null);setReadSearchQ('');}}
                style={{display:'flex',alignItems:'center',gap:5,background:T.gF+'28',border:`1px solid ${T.gD}40`,borderRadius:7,color:T.gT,fontFamily:FS,fontSize:9,letterSpacing:'0.08em',fontWeight:600,padding:'6px 12px',cursor:'pointer',flexShrink:0,whiteSpace:'nowrap',transition:'all .15s'}}>
                ← Back to Reading
              </button>
          ...
          {stripOpen&&(
            <div className={stripClosing?'slide-down-strip':'slide-up-strip'} style={{position:'fixed',bottom:0,left:0,right:0,zIndex:160,background:T.gF,borderTop:`1px solid ${T.gD}`,padding:readFullScreen.current?'10px 12px':'10px 12px 34px',display:'flex',flexDirection:'column',gap:8}}>
              {readBmOk
